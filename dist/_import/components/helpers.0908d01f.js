...
import * as Inputs from "../../_observablehq/stdlib/inputs.b5967c66.js";
import _ from "../../_npm/lodash@4.17.21/cbfa4f05.js";
import {html} from "../../_npm/htl@0.3.1/063eb405.js";
import {FileAttachment} from "../../_observablehq/stdlib.3080ab4f.js";
...
import markdownit from "../../_npm/markdown-it@14.1.0/65e786b3.js"; 
...
const img_src_alpinespace = await FileAttachment({"name":"../../assets/X-RISK-CC_Logo_Landscape_large.png","mimeType":"image/png","path":"../../_file/assets/X-RISK-CC_Logo_Landscape_large.a73a7cd9.png","lastModified":1748765280700,"size":64926}, import.meta.url).arrayBuffer()
const img_src_uba = await FileAttachment({"name":"../../assets/uba.png","mimeType":"image/png","path":"../../_file/assets/uba.ca57b468.png","lastModified":1768814578342,"size":11711}, import.meta.url).arrayBuffer()
